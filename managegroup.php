	...
	<div class="main">
		...
		<center>
			...
			<div class="containersearch">
				<h3 style="text-align:center;">ICT Bookmarks - New Link Group</h3>
			</div>
				...
				<div class="tableFixHead">
					<form method="post" enctype="multipart/form-data">
						...
						<table>
							...
							<thead>
								<th width='20%'><span style="text-decoration: underline; color: #808080;">New group</span></th>
								<th style="text-align:right;" width='80%' ><a href='deletegroup.php'>Delete group</a></th>
							</thead>
							...
							<tr>
							<td width='20%'>
								<p style="text-align:right;"><strong>Enter Group Name</strong></p>
							</td>
							<td width='80%'>
								<input type="text" name="name" placeholder="Enter Group Name" class="form-control" value="" required/>
							</td>
							</tr>													
